...
func adjust_sliders() :
	...
	get_node("Apoptosis_level").set_ticks(apoptosis)
	get_node("Wall_damage_level").set_ticks(wall_damage_level)	
	get_node("Stress_level").set_ticks(stress_level)
	get_node("Apoptosis_level").set_ticks(dna_damage_level)
